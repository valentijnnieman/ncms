          ...
          <form onSubmit={this.updatePost.bind(this)}>
            ...
            <div className='row'>
              ...
              <div className='col s2 offset-s8'>
                <button className='btn red right' onClick={() => this.removePost(item.slug)}>Remove</button>
              </div>
            </div>
            </form>
            <div className='row'>
            ...
            <div className='row'>
              <div className='col s4'>
                <a className='btn yellow' href={'/posts/' + item.slug}>Show</a>
              </div>
            </div>
          </div>
        </li>
